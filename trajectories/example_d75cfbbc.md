...
**Final answer:** HTTP 402 status code
...
- Model's reasoning: The passage explicitly states that exceeding the daily cap on Growth and Enterprise tiers returns an HTTP 402 status code.
