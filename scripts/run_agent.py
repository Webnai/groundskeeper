...
Usage:
    ...
    python scripts/run_agent.py --output-dir output/other --trajectories-dir trajectories/other
"""
...
DEFAULT_TRAJECTORIES_DIR = Path(__file__).parent.parent / "trajectories"


async def main(max_retries: int, max_concurrency: int, output_dir: Path, trajectories_dir: Path) -> None:
...
if __name__ == "__main__":
    ...
    asyncio.run(main(args.max_retries, args.max_concurrency, args.output_dir, args.trajectories_dir))
